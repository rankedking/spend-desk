  ...
  return (
    <div className="subgrid-two-item grid-common grid-c6">
        <div className="grid-c-title">
            <h3 className="grid-c-title-text">Total Income</h3>
                        ...
                        <div className="grid-item" key = { saving.id }>
                            ...
                            <div className="grid-item-bottom">
                                <div className="grid-item-badges">
                                    <span className="grid-item-badge">Since { saving.date_taken }</span>
                                    <span className="grid-item-badge">Amount Saved/Invested $ { saving.amount_left }</span>
                                </div>
