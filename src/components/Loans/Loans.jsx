  ...
  return (
    <div className="subgrid-two-item grid-common grid-c7">
        <div className="grid-c-title">
            <h3 className="grid-c-title-text">Company's Loan Records</h3>
        ...
        <div className="grid-c7-content">
            ...
            <ul className="data-list">
                <li className="data-item text-silver-v1">
                    <span className="data-item-text">Received Loans</span>
                    <span className="data-item-value">$ 500,000</span>
                </li>
                <li className="data-item text-silver-v1">
                    <span className="data-item-text">Repaid Amount</span>
